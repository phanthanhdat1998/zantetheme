...
Redux::setSection(
    ...
    array(
        ...
        'desc'        => esc_html__('Note: Padding value is in px. (min. 0px)', 'zante'),
        'default'     => '24',
    ),
    ...
    array(
        ...
        'type'        => 'text',
        'class'       => 'small-text',
        'title'       => esc_html__('Header Top/Bottom Padding', 'zante'),
        'desc'        => esc_html__('Note: Padding value is in px. (min. 0px)', 'zante'),
        'default'     => '30',
    ),
    ...
    array(
        ...
        'type'        => 'text',
        'class'       => 'small-text',
        'title'       => esc_html__('Header Button Top/Bottom Padding', 'zante'),
        'desc'        => esc_html__('Note: Padding value is in px. (min. 0px)', 'zante'),
        'default'     => '20',
    ),
    ...
    array(
        ...
        'type'        => 'text',
        'class'       => 'small-text',
        'title'       => esc_html__('Mobile Logo Height', 'zante'),
        'desc'        => esc_html__('Note: Logo Height value is in px.', 'zante'),
        'default'     => '24',
      ),
      ...
      array(
          ...
          'type'        => 'text',
          'class'       => 'small-text',
          'title'       => esc_html__('Mobile Logo Top/Bottom Padding', 'zante'),
          'desc'        => esc_html__('Note: Padding value is in px. (min. 0px)', 'zante'),
          'default'     => '15',
      ),

      array(
          'id'          => 'mobile_menu_button_padding',
          'type'        => 'text',
          'class'       => 'small-text',
          'title'       => esc_html__('Mobile Menu Icon Top/Bottom Padding', 'zante'),
          'desc'        => esc_html__('Note: Padding value is in px. (min. 0px)', 'zante'),
          'default'     => '10',
      ),
    ...
    array(
      'id'          => 'menu_color_on_scroll',
      'type'        => 'link_color',
      'title'       => esc_html__('Main Menu Color on Scroll', 'zante'),
      'default'     => array(
          'regular' => '#606060',
          'hover'   => '#deb666',
          'active'  => '#deb666',
    ...
    'fields'          => array(
      ...
      array(
        ...
        array(
            ...
            'type'       => 'color_gradient',
            'title'      => esc_html__('Gradient Overlay Color', 'zante'),
            'subtitle'   => esc_html__('Gradient Color', 'zante'),
            'default'  => array(
                'from' => '#0870f9',
                'to'   => '#ed6392',
            ),
            'required'   => array( 'gradient_overlay', '=', true )
        ),
    ...
    'fields'           => array(
      ...
      array(
        ...
        array(
            'id' => 'footer_copyright',
            'type' => 'text',
            'title' => __('Copyright Text', 'zante'),
            'subtitle' => __('Please enter the copyright text. e.g. &copy; 2021 Hotel Zante. All Rights Reserved', 'zante'),
        ),
        ...
        array(
            ...
            'type'        => 'color',
            'title'       => esc_html__(' Copyright Text Color', 'zante'),
    ...
    'fields'           => array(
      ...
      array(
        ...
        array(
              ...
              'type'        => 'color',
              'title'       => esc_html__('Page Header Text Color', 'zante'),
              'transparent' => false,
              'default'     => '#606060',
          ),
...
Redux::setSection(
    ...
    array(
        ...
        'desc'           => wp_kses(sprintf(__("We suggest translating the Zante theme by using <strong><a href='%s' target='_blank'> WPML </a></strong>", 'zante'), 'https://wpml.org/?aid=225435&affiliate_key=xqc1kSQTtLzj'), wp_kses_allowed_html('post')),
        'fields'         => array(
