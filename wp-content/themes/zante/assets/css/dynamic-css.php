...
$menu_color_on_scroll = zante_get_option('menu_color_on_scroll');
...
$page_header_bg = zante_get_option('page_header_color_bg');
$page_header_color = zante_get_option('page_header_text_color');
...
$header_padding = zante_get_option( 'header_padding' );
$header_button_padding = zante_get_option( 'header_button_padding' );

$mobile_logo_height = zante_get_option( 'mobile_logo_height' );
$mobile_logo_padding = zante_get_option( 'mobile_logo_padding' );
$mobile_menu_button_padding = zante_get_option( 'mobile_menu_button_padding' );

$gradient_overlay_color = zante_get_option( 'gradient_overlay_color' );
...
body {
    ...
    font-family: <?php echo wp_kses_post($main_font['font-family']); ?>, sans-serif;
    <?php endif; ?>
...
header {
    ...
    font-family: <?php echo wp_kses_post($nav_font['font-family']); ?>, sans-serif;
    <?php endif; ?>
...
#main_menu .navbar-nav li a {
  ...
  padding: <?php echo esc_html($header_padding) ?>px 20px;
  <?php endif ?>
}

#main_menu .navbar-nav .menu_button {
  <?php if ( !empty($header_button_padding) ) : ?>
  padding: <?php echo esc_html($header_button_padding) ?>px 0;
  <?php endif ?>
}
...
h6 a:focus {
		...
		font-family: <?php echo wp_kses_post($h_font['font-family']); ?>, sans-serif;
		<?php endif; ?>
...
header.scroll #main_menu .navbar-nav li a {
  <?php if (!empty( $menu_color_on_scroll['regular'] )) : ?>
	color: <?php echo esc_html( $menu_color_on_scroll['regular'] ) ?>;
  <?php endif ?>
}
header.scroll #main_menu .navbar-nav li a:hover {
  <?php if (!empty( $menu_color_on_scroll['hover'] )) : ?>
	color: <?php echo esc_html( $menu_color_on_scroll['hover'] ) ?>;
  <?php endif ?>
}
header.scroll #main_menu .navbar-nav li a:active,
header.scroll #main_menu .navbar-nav .open .dropdown-toggle {
  <?php if (!empty( $menu_color_on_scroll['active'] )) : ?>
	color: <?php echo esc_html( $menu_color_on_scroll['active'] ) ?>;
  <?php endif ?>
}
...
.page-title.page-title-image .breadcrumb li:last-child {
  ...
  <?php if ($page_header_color) : echo 'color:'.$page_header_color; endif; ?>

}

.eb-page-header.eb-page-header-color {
  <?php if ($page_header_bg && zante_get_option('page_header') == 'color') : echo 'background:'.$page_header_bg; endif; ?>;
}
...
.eb-page-header-image:after {
  ...
  <?php if ( !empty($gradient_overlay_color) ) : ?>

    background: -webkit-gradient(linear, left bottom, right top, from(<?php echo esc_html( $gradient_overlay_color['from'] ); ?>), to(<?php echo esc_html( $gradient_overlay_color['to'] ); ?>));
    background: linear-gradient(to top right, <?php echo esc_html( $gradient_overlay_color['from'] ); ?> 0%, <?php echo esc_html( $gradient_overlay_color['to'] ); ?> 100%);
...
-----------------------------------------------------------*/
 @media only screen and (max-width: 991px) {
  ...
  header .navbar-header .navbar-brand {
    <?php if (!empty( $mobile_logo_padding )) : ?>
      padding: <?php echo esc_html( $mobile_logo_padding ) ?>px 0;
    <?php endif ?>
  }

  header .navbar-header .navbar-brand img {
    <?php if (!empty( $mobile_logo_height )) : ?>
      max-height: <?php echo esc_html( $mobile_logo_height ) ?>px;
    <?php endif ?>
  }

  header .navbar-header .mobile_menu_btn {
    <?php if (!empty( $mobile_menu_button_padding )) : ?>
      padding: <?php echo esc_html( $mobile_menu_button_padding ) ?>px 0;
    <?php endif ?>
  }
