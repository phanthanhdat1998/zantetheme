...
function zante_required_plugins()
{
    ...
    $plugins = array(
        array(
            ...
            'slug' => 'eagle-core',
            'source' => 'https://api.eagle-themes.com/download/zante/aninoj081613/eagle-core.zip',
            'required' => true,
            'version' => '1.1.7',
        ) ,
        array(
            ...
            'source' => 'https://api.eagle-themes.com/download/zante/aninoj081613/eagle-demo-importer.zip',
            'required' => true,
            'version' => '1.0',
        ) ,
        array(
            ...
            'slug' => 'eagle-booking',
            'source' => 'https://api.eagle-themes.com/download/zante/aninoj081613/eagle-booking.zip',
            'required' => true,
            'version' => '1.3.3.4',
        ) ,
        array(
            ...
            'slug' => 'revslider',
            'source' => 'https://api.eagle-themes.com/download/zante/aninoj081613/revslider.zip',
            'required' => true,
            'version' => '6.5.18',
        ) ,
        array(
            ...
            'slug' => 'js_composer',
            'source' => 'https://api.eagle-themes.com/download/zante/aninoj081613/js_composer.zip',
            'required' => true,
            'version' => '6.8.0',
        ) ,
        array(
            ...
            'slug' => 'envato-market',
            'source' => 'https://api.eagle-themes.com/download/zante/aninoj081613/envato-market.zip',
            'required' => true,
            'version' => '2.0.6',
        ) ,
        array(
